...
class Classifier:
    def __init__(self):
        ...
        self.pathCat = {
            ...
            "безопасность": Path("../SortedInbox/Seсurity"),
        ...
        self.categories = {
            "инциденты": {
                "ключевые сигналы": [
                    ...
                    "авари", "краш", "срочно", "перегруз"
                ],
                "обычные сигналы": [
                    "завис", "перестал", "останов", "неоткрыва", "неработа",
                    "незагружа", "неотвеча", "переустанов", "тормоз", "запуск",
                    "слома"
                ]
            },
            "спам": {
            ...
            "безопасность": {
                "ключевые сигналы": [
                    ...
                    "мошенн", "угна", "укра", "вирус", "несанкционированн"
                ],
                "обычные сигналы": [
                    "парол", "подозрительн", "вредоносн", "логин", "аккаунт",
