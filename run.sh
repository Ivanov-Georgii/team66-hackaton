...
if [ "$ans" = "1" ]; then
  ...
  echo ""
  echo "Important : $((important-1))"
  echo "Incidents : $(($incidents-1))"
  echo "Noreply.  : $((noreply-1))"
  echo "Other     : $((other-1))"
  echo "Questions : $((questions-1))"
  echo "Security  : $((security-1))"
  echo "Spam      : $((spam-1))"
  echo "Unreadable: $((unreadable-1))"
echo ""
echo "Всего файлов: $((total-8))"
fi
echo ""
